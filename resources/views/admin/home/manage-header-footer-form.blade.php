        ...
        <div class="col-12 pl-0 pr-0">
            ...
            <form method="POST" action="{{ route('header-and-footer-update') }}" enctype="multipart/form-data" autocomplete="" class="form-inline">
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="copyright" type="text" class="col-sm-9 form-control @error('copyright') is-invalid @enderror" name="copyright" value="{{ $headerFooter->copyright }}" placeholder="Copyright Text" required autofocus>
                    @error('copyright')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
